...
INSERT INTO comments (post_id, name, email, comment_text, created_at, status)
VALUES
    (1, 'John Smith', 'j@j.com', 'This is the first comment for post 1.', NOW(), 'new'),
    ...
    (2, 'Sarah Lee', 's@l.com', 'This is the first comment for post 2.', NOW(), 'new'),
    ...
    (3, 'Tom Johnson', 't@j.com', 'This is the first comment for post 3.', NOW(), 'new'),
    ...
    (4, 'Sarah Lee', 's@l.com', 'This is the first comment for post 4.', NOW(), 'new'),
    ...
    (5, 'Jane Doe', 'j@d.com', 'This is the first comment for post 5.', NOW(), 'new'),
    ...
    (6, 'David Kim', 'd@k.com', 'This is the first comment for post 6.', NOW(), 'new'),
    ...
    (7, 'Jane Doe', 'j@d.com', 'This is the first comment for post 7.', NOW(), 'new'),
    ...
    (8, 'David Kim', 'd@k.com', 'This is the first comment for post 8.', NOW(), 'new'),
    ...
    (9, 'Jane Doe', 'j@d.com', 'This is the first comment for post 9.', NOW(), 'new'),
    ...
    (10, 'David Kim', 'd@k.com', 'This is the first comment for post 10.', NOW(), 'new'),
